...
async function SlowComponent() {
  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" withBorder>
      <Title order={3} c="green">データ読み込み完了！</Title>
      <Text c="dimmed" mt="sm">
        3秒の遅延後に表示されるコンテンツです。
      </Text>
    </Card>
    ...
    <Container size="sm" py="xl">
      <Stack gap="xl">
        <div>
          ...
          <Text c="dimmed" mt="sm">
            このページでは、Next.js App Routerのloading.tsxの動作を確認できます。
          </Text>
        </div>

        <Card shadow="sm" padding="lg" radius="md" withBorder>
          <Title order={2} mb="md">テスト方法</Title>
          <Stack gap="sm">
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder bg="blue.0">
          <Title order={3} c="blue">ℹ️ 技術詳細</Title>
          <Text size="sm" mt="sm">
            <strong>loading.tsx</strong>はNext.js App Routerの特殊ファイルで、
            ページコンポーネントがロードされる間に自動的に表示されます。
            React Suspenseの境界として機能し、UXを向上させます。
          </Text>
        </Card>
      </Stack>
    </Container>
